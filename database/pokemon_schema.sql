...
CREATE TABLE pokemon_db.power_values(
	power int PRIMARY KEY
);

CREATE TABLE pokemon_db.accuracy_values(
	accuracy int PRIMARY KEY
);

CREATE TABLE pokemon_db.pp_values(
	pp int PRIMARY KEY
);

CREATE TABLE pokemon_db.type_categories(
...
CREATE TABLE pokemon_db.typing(
	typing_name varchar(10) PRIMARY KEY
);
...
CREATE TABLE pokemon_db.effect_types(
	effect_name varchar(20) PRIMARY KEY
);
...
CREATE TABLE pokemon_db.evolution_group(
